...
star_display.addAnimation('1star',star_1)
star_display.addAnimation('2star',star_2)
...
function draw() 
{
  ...
  if(collided(fruit,star,20)==true){
    star.visible = false
    star_display.changeAnimation("1star")
  }
  if(collided(fruit,star2,20)==true){
    star2.visible = false
    star_display.changeAnimation("2star")
  }
